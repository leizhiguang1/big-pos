...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn('flex h-auto max-w-full items-center justify-start overflow-x-auto rounded-md border border-border bg-card p-1 text-muted-foreground shadow-xs', className)}
    {...props}
  />
))
